...
```
tax_tree(410657) AND instrument_platform="ILLUMINA" AND library_layout="PAIRED" AND library_selection="RANDOM" AND library_source="METAGENOMIC" AND library_strategy="WGS" AND first_created<=2020-12-31
```
```
...
Results are downloaded in tsv and xml format for further curation and plotting.
